...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function() {
        ...
        function h(t) {
            if (t.active)
                for (var e in t.closest) m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(t.closest[e].x, t.closest[e].y), m.strokeStyle = "rgba(3,3,3," + t.active + ")", m.stroke()
        }
        ...
        function l(t, e, i) {
            ...
            ! function() {
                ...
                n.active && (m.beginPath(), m.arc(n.pos.x, n.pos.y, n.radius, 0, 2 * Math.PI, !1), m.fillStyle = "rgba(3,3,3," + n.active + ")", m.fill())
            }
        }
